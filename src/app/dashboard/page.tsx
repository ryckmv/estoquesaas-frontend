  ...
  return (
    <div className="min-h-screen bg-slate-100 p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500">Bem-vindo ao Estoque SaaS</p>
      </div>
        ...
        <div className="bg-white rounded-xl shadow p-6">
          ...
          <div className="space-y-4">
            <Linha
              ...
              valor={(dados?.estoque?.valorEstoque ?? 0).toLocaleString(
                "pt-BR",
                {
                  style: "currency",
                  currency: "BRL"
            ...
            <tbody>
              {(dados?.ultimasVendas ?? []).map((venda) => (
                ...
                >
                  ...
                  <td className="p-4">{venda.usuario}</td>
                  <td className="p-4 font-semibold">
                    {(venda?.valor ?? 0).toLocaleString(
                      "pt-BR",
                      {
                        style: "currency",
                        currency: "BRL"
                  ...
                  <td className="p-4">
                    {venda?.criadoEm ? new Date(venda.criadoEm).toLocaleDateString("pt-BR") : "-"}
                  </td>
                </tr>
              ))}
            </tbody>
